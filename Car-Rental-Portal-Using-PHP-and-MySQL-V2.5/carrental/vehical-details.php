...
#$query1->bindParam(':td',$td,PDO::PARAM_STR);
$query1->execute();
...
$sql="INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromDate,ToDate,message,Status,td) VALUES(:bookingno,:useremail,:vhid,:fromdate,:todate,:message,:status,:td)";
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
			...
			<div class="form-group">
              ...
              <input type="number_format" class="form-control" name="td" placeholder="total distance" required>
            </div>
            <div class="form-group">
